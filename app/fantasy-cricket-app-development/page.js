...
function fantasycricketAppDevelopment() {
    return (
        <>
            ...
            {/* about Section start */}
            <div class="relative bg-gray-100 py-6 md:py-8 lg:py-16 overflow-hidden">
                <div class="mx-auto max-w-7xl px-6 lg:px-8 xl:-my-10 lg:-my-8 md:-my-6 w-full">
                    <div class="mx-auto max-w-container gap-7 flex md:flex-row-reverse flex-col max-lg:gap-4 items-center">

                        <div class="flex max-md:flex-col overflow-hidden xl:-mx-10 lg:-mx-8 md:-mx-6 max-md:gap-y-8">
                            <div class="flex flex-col md:w-1/2 w-full max-md:gap-y-8">
                                <div class="xl:m-10 lg:m-8 md:m-6 overflow-hidden">
                                    <div class="w-full relative z-20 h-auto shrink-1 grow-0">
                                        <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black text-balance">
                                            <span>We build world-class, </span> <span class="font-bold text-theme2">award-winning fantasy cricket apps</span>
                                        </p>
                                        <p class="mt-4 text-sm md:text-base leading-7 text-slate-600 text-balance">
                                ...
                                <div class="xl:m-10 lg:m-8 md:m-6 overflow-hidden rounded-xl md:rounded-2xl !rounded-br-none shadow-xl shadow-indigo-900/10 md:hover:-translate-y-2 duration-300">
                                    <figure class="relative">
                                        <Image width={1000} height={1000} loading='lazy' quality={90} src="/img/league-app.jpeg" alt="League11" class="block w-full object-contain aspect-[400/350]" />
                                        <figcaption class="w-full block p-10 bg-gradient-to-t from-white via-white to-transparent from-75% relative z-[1] -mt-20">
                                            <div class="lg:text-2xl md:text-xl text-lg text-indigo-950 text-balance font-semibold">League11</div>
                                            <p class="mt-4 text-sm md:text-base leading-7 text-slate-600">League11 gives you the smoothest platform with the lowest platform fee 3% ever. Now you can play at your comfort zone in multiple games in 24*7 running matches and win the biggest cash prizes.</p>
                                        </figcaption>
                                    </figure>
                                </div>
                                ...
                                <div class="xl:m-10 lg:m-8 md:m-6 overflow-hidden rounded-xl md:rounded-2xl !rounded-br-none shadow-xl shadow-indigo-900/10 md:hover:-translate-y-2 duration-300">
                                    <figure class="relative">
                                        <Image width={1000} height={1000} loading='lazy' quality={90} src="/img/batball11-app.jpeg" alt="Batball11" class="block w-full object-contain aspect-[400/300]" />
                                        <figcaption class="w-full block p-10 bg-gradient-to-t from-white via-white to-transparent from-75% relative z-[1] -mt-20">
                                            <div class="lg:text-2xl md:text-xl text-lg text-indigo-950 text-balance font-semibold">Batball11</div>
                                            <p class="mt-4 text-sm md:text-base leading-7 text-slate-600 ">BatBall11 is a dreamy ethereal platform for all the sports lovers to experience the most earnest sports and games experience, virtually!</p>
                                        </figcaption>
                                    </figure>
                                </div>
                            </div>
                            <div class="flex flex-col md:w-1/2 w-full max-md:gap-y-8">
                                <div class="xl:m-10 lg:m-8 md:m-6 overflow-hidden rounded-xl md:rounded-2xl !rounded-br-none shadow-xl shadow-indigo-900/10 md:hover:-translate-y-2 duration-300">
                                    <figure class="relative">
                                        <Image width={1000} height={1000} loading='lazy' quality={90} src="/img/fab11.jpeg" alt="Myfab11" class="block w-full object-contain aspect-[400/300]" />
                                        <figcaption class="w-full block p-10 bg-gradient-to-t from-white via-white to-transparent from-75% relative z-[1] -mt-20">
                                            <div class="lg:text-2xl md:text-xl text-lg text-indigo-950 text-balance font-semibold">Myfab11</div>
                                            <p class="mt-4 text-sm md:text-base leading-7 text-slate-600">MyFab11 offers Sports Game formats for cricket, football games, among others, through the Platform. We have offered Sports Games through the Platform since 2018.</p>
                                        </figcaption>
                                    </figure>
                                </div>
                                ...
                                <div class="xl:m-10 lg:m-8 md:m-6 overflow-hidden rounded-xl md:rounded-2xl !rounded-br-none shadow-xl shadow-indigo-900/10 md:hover:-translate-y-2 duration-300">
                                    <figure class="relative">
                                        <Image width={1000} height={1000} loading='lazy' quality={90} src="/img/jeet11-app.jpeg" alt="Jeet11" class="block w-full object-contain aspect-[400/400]" />
                                        <figcaption class="w-full block p-10 bg-gradient-to-t from-white via-white to-transparent from-75% relative z-[1] -mt-20">
                                            <div class="lg:text-2xl md:text-xl text-lg text-indigo-950 text-balance font-semibold">Jeet11</div>
                                            <p class="mt-4 text-sm md:text-base leading-7 text-slate-600 ">Jeet11 is India's Fastest growing fantasy platform. Use your gaming knowledge and win big!</p>
                                        </figcaption>
                                    </figure>
                                </div>
                            </div>
            ...
            <div class="relative bg-white py-6 md:py-8 lg:py-16 select-none">
                <div class="mx-auto max-w-7xl px-6 lg:px-8 w-full">

                    <div class="mx-auto max-w-container gap-7 flex md:flex-row flex-col max-lg:gap-4 items-center">

                        <div class="md:w-3/5 w-full relative z-20 h-auto shrink-1 grow-0">
                            <p class="
            ...
            <div class="relative overflow-hidden bg-gray-100">
                <div class="mx-auto max-w-7xl px-6 lg:px-8  z-[1] relative py-10 overflow-hidden">
                    <div class="mx-auto max-w-container gap-3 px-4 sm:px-6 md:flex lg:px-8 md:flex-col text-center">
                        <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-gray-800 text-balance">
                            <span class="font-normal">Unleash the Power of Fantasy Cricket: </span>
                            <span class="font-bold bg-gradient-to-r from-gray-800 via-yellow-600 to-gray-800 bg-clip-text text-theme2">Cutting-Edge Features, Endless Excitement! </span>
                        </p>
                    </div>
                    <div class="flex flex-wrap mt-10 ">
                        <div class="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                            <div class="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                                <div class="pb-3">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="size-11 text-black" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="font-bold text-black md:text-xl text-lg relative">Instant Score Update</div>
                                <div class="text-gray-800 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">All Match Score get updated by API automatically.</div>
                            </div>
                        </div>
                        <div class="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                            <div class="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                                ...
                                <div class="font-bold text-black md:text-xl text-lg relative">KYC &amp; Payment Withdrawal</div>
                                <div class="text-gray-800 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Easy KYC Approval and Payment Withdrawal.</div>
                            </div>
                        </div>
                        <div class="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                            <div class="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                                <div class="pb-3">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.2" baseProfile="tiny" viewBox="0 0 24 24" class="size-11 text-black" xmlns="http://www.w3.org/2000/svg"><path d="M11 20c-.801 0-1.555-.312-2.121-.879l-4-4c-.567-.566-.879-1.32-.879-2.121s.312-1.555.879-2.122c1.133-1.133 3.109-1.133 4.242 0l1.188 1.188 3.069-5.523c.526-.952 1.533-1.544 2.624-1.544.507 0 1.012.131 1.456.378.7.39 1.206 1.028 1.427 1.798.221.771.127 1.581-.263 2.282l-5 9c-.454.818-1.279 1.384-2.206 1.514-.139.019-.277.029-.416.029zm-4-8c-.268 0-.518.104-.707.293s-.293.439-.293.707.104.518.293.707l4 4c.223.221.523.33.844.283.312-.043.586-.232.737-.504l5-9c.13-.233.161-.503.088-.76-.073-.257-.243-.47-.478-.6-.473-.264-1.101-.078-1.357.388l-4.357 7.841-3.062-3.062c-.19-.189-.44-.293-.708-.293z"></path></svg>
                                </div>
                                <div class="font-bold text-black md:text-xl text-lg relative">1 Click Settlement</div>
                                <div class="text-gray-800 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Settle Payments in Single Click.</div>
                            </div>
                        </div>
                        <div class="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                            <div class="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                                ...
                                <div class="font-bold text-black md:text-xl text-lg relative">Match Cancellation</div>
                                <div class="text-gray-800 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Automatic Match cancellation by API.</div>
                            </div>
                        </div>
                        <div class="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                            <div class="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                                ...
                                <div class="font-bold text-black md:text-xl text-lg relative">Join with Multiple Team</div>
                                <div class="text-gray-800 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">You can join with Multiple Teams in a Contest.</div>
                            </div>
                        </div>
                        <div class="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                            <div class="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                                <div class="pb-3">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="size-11 text-black" xmlns="http://www.w3.org/2000/svg"><g id="Settings"><g><path d="M12.6,20.936H11.3a.883.883,0,0,1-.852-.654l-.774-2.833-2.5,1.435a.886.886,0,0,1-1.06-.138l-.925-.919a.884.884,0,0,1-.143-1.066l1.469-2.545L6.509,14.2l-2.787-.747a.882.882,0,0,1-.654-.851V11.3a.882.882,0,0,1,.652-.85l2.839-.777L5.12,7.171a.885.885,0,0,1,.141-1.062l.918-.918A.885.885,0,0,1,7.24,5.049L9.792,6.514l.012,0,.745-2.79a.881.881,0,0,1,.851-.655h1.3a.883.883,0,0,1,.852.655l.762,2.838,2.509-1.441a.885.885,0,0,1,1.059.138l.926.919a.882.882,0,0,1,.141,1.067L17.483,9.777l.008.022,2.786.746a.883.883,0,0,1,.653.851v1.3a.883.883,0,0,1-.654.852l-2.837.774,1.439,2.505a.881.881,0,0,1-.141,1.063l-.917.917a.888.888,0,0,1-1.063.141l-2.539-1.462L14.2,17.5l-.745,2.785A.885.885,0,0,1,12.6,20.936Zm-1.21-1h1.119l.738-2.756a.888.888,0,0,1,.528-.592l.134-.052a.873.873,0,0,1,.76.057l2.51,1.445.789-.789-1.423-2.478a.881.881,0,0,1-.048-.78l.052-.125a.875.875,0,0,1,.584-.51l2.8-.749v-1.12l-2.755-.737a.885.885,0,0,1-.592-.529l-.052-.132a.882.882,0,0,1,.057-.763L18.04,6.818l-.8-.79-2.48,1.425a.878.878,0,0,1-.772.052l-.115-.047a.888.888,0,0,1-.518-.588l-.748-2.806H11.492l-.738,2.762a.883.883,0,0,1-.539.6l-.12.045a.874.874,0,0,1-.751-.058L6.822,5.962l-.789.789L7.455,9.227a.886.886,0,0,1,.046.785l-.051.12a.876.876,0,0,1-.579.5l-2.8.758v1.121l2.757.738a.889.889,0,0,1,.591.525l.048.121a.874.874,0,0,1-.055.77L5.958,17.181l.8.791,2.47-1.419a.878.878,0,0,1,.787-.045l.106.044a.874.874,0,0,1,.526.591ZM9.75,17.482l.008,0ZM9.6,17.421l.007,0ZM6.487,14.147h0Zm.044-4.411h0Zm7.724-3.2Z"></path><path d="M12,15a3,3,0,1,1,3-3A3,3,0,0,1,12,15Zm0-5a2,2,0,1,0,2,2A2,2,0,0,0,12,10Z"></path></g></g></svg>
                                </div>
                                <div class="font-bold text-black md:text-xl text-lg relative">Match Fixture</div>
                                <div class="text-gray-800 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Get all Upcoming Matches automatically by API.</div>
                            </div>
                        </div>
                        <div class="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                            <div class="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                                <div class="pb-3">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="size-11 text-black" xmlns="http://www.w3.org/2000/svg"><path d="M12 11C14.7614 11 17 13.2386 17 16V22H15V16C15 14.4023 13.7511 13.0963 12.1763 13.0051L12 13C10.4023 13 9.09634 14.2489 9.00509 15.8237L9 16V22H7V16C7 13.2386 9.23858 11 12 11ZM5.5 14C5.77885 14 6.05009 14.0326 6.3101 14.0942C6.14202 14.594 6.03873 15.122 6.00896 15.6693L6 16L6.0007 16.0856C5.88757 16.0456 5.76821 16.0187 5.64446 16.0069L5.5 16C4.7203 16 4.07955 16.5949 4.00687 17.3555L4 17.5V22H2V17.5C2 15.567 3.567 14 5.5 14ZM18.5 14C20.433 14 22 15.567 22 17.5V22H20V17.5C20 16.7203 19.4051 16.0796 18.6445 16.0069L18.5 16C18.3248 16 18.1566 16.03 18.0003 16.0852L18 16C18 15.3343 17.8916 14.694 17.6915 14.0956C17.9499 14.0326 18.2211 14 18.5 14ZM5.5 8C6.88071 8 8 9.11929 8 10.5C8 11.8807 6.88071 13 5.5 13C4.11929 13 3 11.8807 3 10.5C3 9.11929 4.11929 8 5.5 8ZM18.5 8C19.8807 8 21 9.11929 21 10.5C21 11.8807 19.8807 13 18.5 13C17.1193 13 16 11.8807 16 10.5C16 9.11929 17.1193 8 18.5 8ZM5.5 10C5.22386 10 5 10.2239 5 10.5C5 10.7761 5.22386 11 5.5 11C5.77614 11 6 10.7761 6 10.5C6 10.2239 5.77614 10 5.5 10ZM18.5 10C18.2239 10 18 10.2239 18 10.5C18 10.7761 18.2239 11 18.5 11C18.7761 11 19 10.7761 19 10.5C19 10.2239 18.7761 10 18.5 10ZM12 2C14.2091 2 16 3.79086 16 6C16 8.20914 14.2091 10 12 10C9.79086 10 8 8.20914 8 6C8 3.79086 9.79086 2 12 2ZM12 4C10.8954 4 10 4.89543 10 6C10 7.10457 10.8954 8 12 8C13.1046 8 14 7.10457 14 6C14 4.89543 13.1046 4 12 4Z"></path></svg>
                                </div>
                                <div class="font-bold text-black md:text-xl text-lg relative">Team Lineup</div>
                                <div class="text-gray-800 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Get a Report of Players who are playing in the current Joined Match.</div>
                            </div>
                        </div>
                        <div class="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                            <div class="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                                ...
                                <div class="font-bold text-black md:text-xl text-lg relative">Refer and Earn</div>
                                <div class="text-gray-800 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">You can refer and Earn Referral Money when they Join.</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='container pt-5 md:p-5 sm:p-8 p-5 mx-auto max-w-7xl px-6 lg:px-8 relative z-10'>
                <div class="relative container mx-auto max-w-7xl md:px-6 lg:px-8 z-10 text-center">
                    <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black text-balance">
                        <span class="font-normal">Core </span>
                        <span class="font-bold text-theme2">Features List</span>
                    </p>
                ...
                <div class="flex flex-wrap mt-10 py-10 px-5 items-center bg-theme1 rounded-[20px]">
                    <div class="lg:w-2/6 w-full">
                        <div class="mobileImg sm:w-64 w-52 sm:h-auto h-96 mx-auto">
                            <Image width={1000} height={1000} src="/img/image-fantasy-sports-user-panel.webp" alt="fantasy-sports-user-penal" class="img-fluid h-full w-full " />
                        </div>
                    </div>
                            ...
                            <div class="md:w-1/2 w-full md:p-4 p-3">
                                <div class="sm:p-4 group/db p-3 backdrop-blur-xl rounded-br-none relative duration-500 bg-white/5 shadow-md shadow-white/5 border-4 border-white/5 rounded-xl hover:scale-95 h-full">
                                    <div class="">
                                        ...
                                        <p class="mt-2 sm:text-base text-sm leading-6 font-normal text-white/70 line-clamp-4 text-ellipsis"> With the user authentication feature, the users will be required to fill their certain basic details.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="md:w-1/2 w-full md:p-4 p-3">
                                <div class="sm:p-4 group/db p-3 backdrop-blur-xl rounded-br-none relative duration-500 bg-white/5 shadow-md shadow-white/5 border-4 border-white/5 rounded-xl hover:scale-95 h-full">
                                    <div class="">
                                        <div class="md:text-xl sm:text-lg text-base font-medium leading-6 text-white">Search, List and Filter Matches</div>
                                        <p class="mt-2 sm:text-base text-sm leading-6 font-normal text-white/70 line-clamp-4 text-ellipsis"> Users can search for their favourite matches and apply filters to the matches of their favourite team.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="md:w-1/2 w-full md:p-4 p-3">
                                <div class="sm:p-4 group/db p-3 backdrop-blur-xl rounded-br-none relative duration-500 bg-white/5 shadow-md shadow-white/5 border-4 border-white/5 rounded-xl hover:scale-95 h-full">
                                    <div class="">
                                        <div class="md:text-xl sm:text-lg text-base font-medium leading-6 text-white">Join Tournaments</div>
                                        <p class="mt-2 sm:text-base text-sm leading-6 font-normal text-white/70 line-clamp-4 text-ellipsis">Users can join the tournaments of their favourite sports of their own choice.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="md:w-1/2 w-full md:p-4 p-3">
                ...
                <div class="flex flex-wrap mt-10 items-center bg-theme2 rounded-[20px]">
                    <div class="lg:w-2/6 w-full">
                        <div class="mobileImg sm:w-64 w-52 sm:h-auto h-96 mx-auto">
                            <Image width={1000} height={1000} loading='lazy' quality={90} src="/img/fantasy-sports-admin-penal.webp" alt="fantasy-sports-admin-penal" class="img-fluid h-full w-full " />
                        </div>
                    </div>
                    <div class="lg:w-4/6 w-full">
                        <div class="flex flex-wrap items-stretch">
            ...
            <div class=" border bg-theme1 py-10 relative overflow-hidden  ">
                <div class="mx-auto max-w-7xl px-6 lg:px-8 w-full">
                    <div class="relative container mx-auto max-w-7xl md:px-6 lg:px-8 z-10">
                        <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-white">
                            <span class="font-normal">Additional Fantasy Sports </span>
                            <span class="font-bold text-theme2">Genre We Develop</span>
                        </p>
                        <div class="md:text-base text-sm text-white mt-3">
                ...
                <div class="container pt-5 md:p-5 sm:p-8 p-5 mx-auto max-w-7xl px-6 lg:px-8 relative z-10 flex justify-center">
                    <ul class="
            flex flex-wrap md:pt-8 text-center md:text-left gap-y-6 justify-center items-stretch
        ">
                        <div class="p-4 h-auto lg:w-1/3">
                            <a href="">
                                <div class="group rounded-full overflow-hidden lg:h-[350px] lg:w-[350px] h-[250px] w-[250px] bg-white/5 backdrop-blur-sm text-center flex justify-center items-center flex-col border-[1px] border-solid border-[white]/10 group duration-300 sm:hover:scale-95 sm:hover:border-pink-100">
                                    <Image width={800} height={800} loading='lazy' quality={90} src="/img/football.webp" alt="Football" class="img-fluid mx-auto lg:size-40 size-32 group-hover:md:animate-bounce"/>
                                        <div class="font-bold text-white md:text-xl text-lg relative mt-3">Football</div>
                                </div>
                            </a>
                        </div>
                        <div class="p-4 h-auto lg:w-1/3">
                            <a href="">
                                <div class="group rounded-full overflow-hidden lg:h-[350px] lg:w-[350px] h-[250px] w-[250px] bg-white/5 backdrop-blur-sm text-center flex justify-center items-center flex-col border-[1px] border-solid border-[white]/10 group duration-300 sm:hover:scale-95 sm:hover:border-pink-100">
                                    <Image width={800} height={800} loading='lazy' quality={90} src="/img/Kabaddi.webp" alt="Kabaddi" class="img-fluid mx-auto lg:size-40 size-32 group-hover:md:animate-bounce"/>
                                        <div class="font-bold text-white md:text-xl text-lg relative mt-3">Kabaddi</div>
                                </div>
                            </a>
                        </div>
                        <div class="p-4 h-auto lg:w-1/3">
                            <a href="">
                                <div class="group rounded-full overflow-hidden lg:h-[350px] lg:w-[350px] h-[250px] w-[250px] bg-white/5 backdrop-blur-sm text-center flex justify-center items-center flex-col border-[1px] border-solid border-[white]/10 group duration-300 sm:hover:scale-95 sm:hover:border-pink-100">
                                    <Image width={800} height={800} loading='lazy' quality={90} src="/img/stock.webp" alt="Stock Market" class="img-fluid mx-auto lg:size-40 size-32 group-hover:md:animate-bounce"/>
                                        <div class="font-bold text-white md:text-xl text-lg relative mt-3">Stock Market</div>
                                </div>
                            </a>
                        </div>
                    </ul>
