...
function foodDeliveryAppDevelopment() {
    const accordionItems = [
        {
            title:
                "Which is the Best On-demand Food Delivery App Development Company?",
            content:
                "Although there is a huge list of the best food delivery app development companies, Twin Power Software outshines all. We have decades of experience in food delivery app development solutions. To date, we have helped all businesses grow. Be the next market leader in the food industry while seeking assistance from us.",
        },
        {
            title:
                "Is the On-Demand Food Delivery App Scalable for Business Growth?",
            content:
                "Absolutely! Twin Power Software’s scalable architecture allows your app to grow seamlessly. With our solutions accomodate increased user traffic, transactions, and new features as your business expands.",
        },
        {
            title:
                "How Much Does On-demand Food Delivery App Development Services Cost?",
            content:
                "There is no fixed cost to develop an on-demand food delivery app. It keeps fluctuating from one type of app to the other. So, if you want to know the accurate cost of on-demand food delivery app development services, look no further than Twin Power Software. We have a team of professionals who can help you accomplish your business goals.",
        },
        {
            title:
                "Can the On-Demand Food Delivery App be Customized to Fit Specific Business Needs?",
            content:
                "Yes, our app development process is highly flexible. We work closely with clients to understand their unique requirements. We tailor the app features, branding, and functionality to meet specific business needs.",
        },
        {
            title:
                "How Do I Hire the Best On-demand Food Delivery App Developers?",
            content:
                "To hire dedicated food delivery app developers, connect with a leading food delivery app development company like Twin Power Software. With a team of dedicated professionals, we ensure the delivery of outstanding food delivery app development solutions to businesses worldwide. Feel free to discuss your project requirements with us.",
        },
    ];
...
"
                            ...
                            <div className="flex mx-auto max-lg:flex-col max-lg:gap-y-10 items-center 2xl:max-w-7xl xl:max-w-6xl lg:max-w-5xl md:max-w-3xl sm:max-w-3xl max-w-2xl px-6 lg:px-8 w-full relative lg:pt-40 sm:pt-32 pt-28 pb-12 overflow-hidden z-10 justify-between">
                                <div className="xl:w-7/12 lg:w-1/2 grow-0 max-lg:text-center">
                                    ...
                                    <div className="max-lg:text-sm text-base text-white/80 pt-5 text-pretty w-10/12 max-lg:mx-auto">
                                        Turn your food delivery vision into a thriving reality with
                                        Twin Power Software, a leading food delivery app development
                                        company. We possess the expertise and resources to create
                                        exceptional user experiences while driving your business
                                        growth.
                                    </div>
                                </div>
                        ...
                        <div className="lg:mx-0 lg:flex-auto py-6 md:py-8 lg:py-16 text-center relative z-[1]  ">
                            <div className="max-sm:text-xl max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight text-white font-normal empty:hidden max-sm:text-center">
                                ...
                                <span className="font-bold text-gray-100">
                                    annual growth rate (CAGR 2024-2028) of 10.06%, resulting in a
                                    projected market volume of US$1.79tn by 2028."{" "}
                                </span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="flex [transform:rotateY(180deg)] group-[]/flip:[transform:rotateY(0deg)]">
                                <div className="relative flex-shrink-0 p-4 w-full">
                                    <div className="relative z-10 overflow-hidden *:rounded-xl [transform:rotateY(180deg)] group-[]/flip:[transform:rotateY(0deg)] [&~*]:[&:has(.mask)]:lg:hidden">
                                        <Image
                                            className="object-contain w-full h-auto md:w-[336px] aspect-[1/1.2] content1-img"
                                            width={"1000"}
                                            height={"1000"}
                ...
                "
                            >
                                <span className="font-normal">
                                    Create a compelling food delivery app{" "}
                                </span>{" "}
                                <span className="font-bold text-theme2">
                                    similar to Uber Eats and GrubHub
                                </span>
                            </p>
                            <p className="mt-4 text-sm md:text-base leading-7 text-slate-600">
                                In recent years, food delivery apps have revolutionized the way
                                people order meals. Leading platforms like Uber Eats and Grubhub
                                have demonstrated the market’s potential and the significant
                                profits it can offer. If you’re looking to enter this lucrative
                                space, a custom-built app can distinguish you from the
                                competition, boost customer satisfaction, and solidify your
                                presence in the industry.
                            </p>
                            <p className="mt-4 text-sm md:text-base leading-7 text-slate-600">
                                Twin Power Software, a premier food delivery app development
                                company, has the expertise to bring your vision to life and meet
                                user demands. Our skilled team ensures an exceptional user
                                experience, helping you carve out a strong position in the
                                market. Got an idea? Hire mobile app developers today!
                            </p>
            ...
            <section className="bg-gray-100">
                ...
                last:*:font-bold last:*:text-theme2
            ">    <span>Diverse Food Delivery Models </span>
                                <span> Available from Us</span>
                            </p>
                            <div className="md:text-base text-sm text-black/70 mt-3">
                                Are you ready to explore a variety of food delivery options tailored to meet every taste and preference? Our extensive selection of food delivery models includes express delivery for those in a hurry, subscription plans for ongoing convenience, and customizable meal kits for home chefs. Choose on-demand food delivery services from Twin Power Software and gain access to a comprehensive suite of food delivery app development solutions.
                            </div>
                        </div>
                    </div>
...
export default foodDeliveryAppDevelopment;
