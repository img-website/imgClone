        ...
        <>
            ...
            <div className="relative">
                <div className="h-[calc(100vh_-_10px)] relative after:absolute after:top-0 after:left-0 after:h-full after:w-full after:bg-gradient-to-tr  after:via-theme2/80 after:to-theme1/70 after:from-theme1/70 after:backdrop-blur-sm">
                    <Image src="/img/live-streaming-app-development-2048w.webp" width={'1000'} height={'1000'} alt="" className='h-full w-full object-cover overflow-hidden object-top' />
                </div>
                    ...
                    <div className="w-full">
                        <div className="max-w-5xl grow-0 text-center mx-auto text-balance">
                            ...
                            <div className="max-lg:text-sm text-base text-center text-white pt-5 text-balance max-lg:mx-auto">
                                Grow your business by creating a unique and attractive website with interactive features and a rich UI experience. We deliver cost-effective and transparent web development solutions.
                            </div>
            ...
            <div className="">
                ...
                ">
                    ...
                    ">
                                    <span className="font-normal">Best Website Designing &

                                    </span> <span className="font-bold bg-gradient-to-r from-gray-500 via-sky-600 to-gray-500 bg-clip-text text-theme2">Development Company in Delhi</span>

                                </p>
                                <p className="mt-4 text-sm md:text-base leading-7 text-slate-600">
                                    In today's digital age, businesses aim to build a strong online presence through effective web design. Twin Power Software is a leading Website Development Company in Delhi, specializing in creating both templates and custom designs for user-friendly websites. Our solutions are designed to drive lead generation and lay a solid foundation for your business growth. Partnering with us ensures robust website development that delivers scalable results.
                                </p>
                                <p className="mt-4 text-sm md:text-base leading-7 text-slate-600">
                                    Our expert team of developers is dedicated to crafting websites that provide tangible benefits. We offer easy access to user-friendly website designs and support the development of custom web applications. Our mission is to enhance your brand identity through intuitive, mobile-responsive, and engaging websites, ultimately driving more traffic and boosting your business success.
                                    </p>
