...
function fantasyFootball() {
  const accordionItems = [
    {
      title: 'Process of Creating a Fantasy Football Application?',
      content: "Developing a successful fantasy football application for both app and web platforms results from a meticulous approach and the incorporation of vital features. It’s essential to craft a detailed monetization strategy while choosing the appropriate framework for development."
    },
    {
    ...
    {
      title: 'What Is the Cost of Developing a Fantasy Football App?',
      content: 'The rough estimate for developing a fantasy football app is around $800 for both operating systems. For the most competitive pricing, contact Twin Power to discuss your specific requirements and receive a tailored estimate.'
    },
    {
      title: 'What Is the Timeline for Developing a Fantasy Football App?',
    ...
    {
      title: 'What Programming Languages Are Used for Developing Fantasy Football Apps?',
      content: "We utilize Java and Kotlin to develop interactive Android fantasy football apps. For iOS, we use Swift to build a seamless and engaging fantasy app experience."
    },
  ];
  return (
    <>
 ...
 {/* hero----  */}
            <div className="relative">
                <div className="h-[calc(100vh_-_10px)] relative after:absolute after:top-0 after:mix-blend-multiply after:left-0 after:h-full after:w-full after:bg-gradient-to-tr  after:via-theme1/80 after:to-theme2/70 after:from-theme2/70 after:backdrop-blur-sm">
                    <Image src="/img/fantasy-football.webp" width={'1000'} height={'1000'} alt="" className='h-full w-full object-cover overflow-hidden object-top' />
                </div>
                <div className="absolute top-1/2 -translate-y-1/2 flex items-center px-8 sm:px-12 md:px-16 h-full text-white mx-auto w-full">
                    <div className="w-full">
                        <div className="max-w-5xl grow-0 text-center mx-auto text-balance">
                            ...
                            Are you considering a leap into the online gaming arena? Partner with Twin Power and embrace the future with the leading fantasy football platform on the market. Our experienced team of developers is equipped to elevate your business and drive its growth to the next level.
                            </div>
                    ...
                    <div className="xl:m-10 lg:m-8 md:m-6 overflow-hidden">
                        <div className="w-full relative z-20 h-auto shrink-1 grow-0">
                            <p className="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black text-balance">
                                <span>We develop world-class, </span> <span className="font-bold text-theme1">award-winning fantasy football apps that set the standard in the industry.</span>
                            </p>
       ...
       {/* ------ Unleash the Power of Fantasy ---- */}
        ...
        <div className="mx-auto max-w-container gap-3 px-4 sm:px-6 md:flex lg:px-8 md:flex-col text-center">
            <p className="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-gray-800 text-balance">
                <span className="font-normal text-white">Unleash the Power of Fantasy Football: </span> 
        ...
        <div className="flex flex-wrap mt-10 ">
            <div className="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                <div className="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                    <div className="pb-3">                 
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" className="size-11 text-white" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="font-bold text-white md:text-xl text-lg relative">Real-Time Score Updates</div>
                    <div className="text-gray-300 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">All match scores are automatically updated through API integration.</div>
            ...
            <div className="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                <div className="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                    ...
                    <div className="font-bold text-white md:text-xl text-lg relative">KYC Verification & Secure Payment Withdrawals</div>
                    <div className="text-gray-300 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Simple KYC Approval and Hassle-Free Payment Withdrawals.</div>
            ...
            <div className="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                <div className="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                    <div className="pb-3">                 
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.2" baseProfile="tiny" viewBox="0 0 24 24" className="size-11 text-white" xmlns="http://www.w3.org/2000/svg"><path d="M11 20c-.801 0-1.555-.312-2.121-.879l-4-4c-.567-.566-.879-1.32-.879-2.121s.312-1.555.879-2.122c1.133-1.133 3.109-1.133 4.242 0l1.188 1.188 3.069-5.523c.526-.952 1.533-1.544 2.624-1.544.507 0 1.012.131 1.456.378.7.39 1.206 1.028 1.427 1.798.221.771.127 1.581-.263 2.282l-5 9c-.454.818-1.279 1.384-2.206 1.514-.139.019-.277.029-.416.029zm-4-8c-.268 0-.518.104-.707.293s-.293.439-.293.707.104.518.293.707l4 4c.223.221.523.33.844.283.312-.043.586-.232.737-.504l5-9c.13-.233.161-.503.088-.76-.073-.257-.243-.47-.478-.6-.473-.264-1.101-.078-1.357.388l-4.357 7.841-3.062-3.062c-.19-.189-.44-.293-.708-.293z"></path></svg>
                    </div>
                    <div className="font-bold text-white md:text-xl text-lg relative">One-Click Settlement</div>
                    <div className="text-gray-300 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Settle Payments with a Single Click.</div>
            ...
            <div className="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                <div className="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                    ...
                    <div className="font-bold text-white md:text-xl text-lg relative">Match Cancellation Policy</div>
                    <div className="text-gray-300 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Automatic match cancellations are managed through API integration.</div>
            ...
            <div className="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                <div className="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                    ...
                    <div className="font-bold text-white md:text-xl text-lg relative">
                    Join Multiple Teams</div>
                    <div className="text-gray-300 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">You can join multiple teams in a contest.</div>
            ...
            <div className="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                <div className="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                    <div className="pb-3">                 
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" className="size-11 text-white" xmlns="http://www.w3.org/2000/svg"><g id="Settings"><g><path d="M12.6,20.936H11.3a.883.883,0,0,1-.852-.654l-.774-2.833-2.5,1.435a.886.886,0,0,1-1.06-.138l-.925-.919a.884.884,0,0,1-.143-1.066l1.469-2.545L6.509,14.2l-2.787-.747a.882.882,0,0,1-.654-.851V11.3a.882.882,0,0,1,.652-.85l2.839-.777L5.12,7.171a.885.885,0,0,1,.141-1.062l.918-.918A.885.885,0,0,1,7.24,5.049L9.792,6.514l.012,0,.745-2.79a.881.881,0,0,1,.851-.655h1.3a.883.883,0,0,1,.852.655l.762,2.838,2.509-1.441a.885.885,0,0,1,1.059.138l.926.919a.882.882,0,0,1,.141,1.067L17.483,9.777l.008.022,2.786.746a.883.883,0,0,1,.653.851v1.3a.883.883,0,0,1-.654.852l-2.837.774,1.439,2.505a.881.881,0,0,1-.141,1.063l-.917.917a.888.888,0,0,1-1.063.141l-2.539-1.462L14.2,17.5l-.745,2.785A.885.885,0,0,1,12.6,20.936Zm-1.21-1h1.119l.738-2.756a.888.888,0,0,1,.528-.592l.134-.052a.873.873,0,0,1,.76.057l2.51,1.445.789-.789-1.423-2.478a.881.881,0,0,1-.048-.78l.052-.125a.875.875,0,0,1,.584-.51l2.8-.749v-1.12l-2.755-.737a.885.885,0,0,1-.592-.529l-.052-.132a.882.882,0,0,1,.057-.763L18.04,6.818l-.8-.79-2.48,1.425a.878.878,0,0,1-.772.052l-.115-.047a.888.888,0,0,1-.518-.588l-.748-2.806H11.492l-.738,2.762a.883.883,0,0,1-.539.6l-.12.045a.874.874,0,0,1-.751-.058L6.822,5.962l-.789.789L7.455,9.227a.886.886,0,0,1,.046.785l-.051.12a.876.876,0,0,1-.579.5l-2.8.758v1.121l2.757.738a.889.889,0,0,1,.591.525l.048.121a.874.874,0,0,1-.055.77L5.958,17.181l.8.791,2.47-1.419a.878.878,0,0,1,.787-.045l.106.044a.874.874,0,0,1,.526.591ZM9.75,17.482l.008,0ZM9.6,17.421l.007,0ZM6.487,14.147h0Zm.044-4.411h0Zm7.724-3.2Z"></path><path d="M12,15a3,3,0,1,1,3-3A3,3,0,0,1,12,15Zm0-5a2,2,0,1,0,2,2A2,2,0,0,0,12,10Z"></path></g></g></svg>
                    </div>
                    <div className="font-bold text-white md:text-xl text-lg relative">Match Fixture</div>
                    <div className="text-gray-300 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Automatically retrieve all upcoming matches through API integration.</div>
            ...
            <div className="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                <div className="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                    <div className="pb-3">                 
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" className="size-11 text-white" xmlns="http://www.w3.org/2000/svg"><path d="M12 11C14.7614 11 17 13.2386 17 16V22H15V16C15 14.4023 13.7511 13.0963 12.1763 13.0051L12 13C10.4023 13 9.09634 14.2489 9.00509 15.8237L9 16V22H7V16C7 13.2386 9.23858 11 12 11ZM5.5 14C5.77885 14 6.05009 14.0326 6.3101 14.0942C6.14202 14.594 6.03873 15.122 6.00896 15.6693L6 16L6.0007 16.0856C5.88757 16.0456 5.76821 16.0187 5.64446 16.0069L5.5 16C4.7203 16 4.07955 16.5949 4.00687 17.3555L4 17.5V22H2V17.5C2 15.567 3.567 14 5.5 14ZM18.5 14C20.433 14 22 15.567 22 17.5V22H20V17.5C20 16.7203 19.4051 16.0796 18.6445 16.0069L18.5 16C18.3248 16 18.1566 16.03 18.0003 16.0852L18 16C18 15.3343 17.8916 14.694 17.6915 14.0956C17.9499 14.0326 18.2211 14 18.5 14ZM5.5 8C6.88071 8 8 9.11929 8 10.5C8 11.8807 6.88071 13 5.5 13C4.11929 13 3 11.8807 3 10.5C3 9.11929 4.11929 8 5.5 8ZM18.5 8C19.8807 8 21 9.11929 21 10.5C21 11.8807 19.8807 13 18.5 13C17.1193 13 16 11.8807 16 10.5C16 9.11929 17.1193 8 18.5 8ZM5.5 10C5.22386 10 5 10.2239 5 10.5C5 10.7761 5.22386 11 5.5 11C5.77614 11 6 10.7761 6 10.5C6 10.2239 5.77614 10 5.5 10ZM18.5 10C18.2239 10 18 10.2239 18 10.5C18 10.7761 18.2239 11 18.5 11C18.7761 11 19 10.7761 19 10.5C19 10.2239 18.7761 10 18.5 10ZM12 2C14.2091 2 16 3.79086 16 6C16 8.20914 14.2091 10 12 10C9.79086 10 8 8.20914 8 6C8 3.79086 9.79086 2 12 2ZM12 4C10.8954 4 10 4.89543 10 6C10 7.10457 10.8954 8 12 8C13.1046 8 14 7.10457 14 6C14 4.89543 13.1046 4 12 4Z"></path></svg>
                    </div>
                    <div className="font-bold text-white md:text-xl text-lg relative">Team Lineup</div>
                    <div className="text-gray-300 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">Obtain a report of players participating in the currently joined match.</div>
            ...
            <div className="lg:w-1/4 sm:w-1/2 w-full md:p-3 py-6">
                <div className="relative block h-full p-8 group duration-300 md:shadow-none shadow-lg">
                    ...
                    <div className="font-bold text-white md:text-xl text-lg relative">Refer and Earn</div>
                    <div className="text-gray-300 sm:text-base text-sm leading-6 font-normal mt-2 text-ellipsis line-clamp-4">You can refer friends and earn referral money when they join.</div>
