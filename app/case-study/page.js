...
<div class="relative py-6 md:py-8 lg:py-16  px-10 max-sm:px-4 lg:mt-10 mt-20" id="allCaseStudy">
    <div class="mx-auto max-w-7xl mb-24 last:mb-10 px-6 lg:px-8 w-full shadow-2xl shadow-theme1/60 bg-theme1 rounded-3xl *:relative *:z-10 relative">
        <div class="mx-auto max-w-container gap-x-7 max-sm:gap-0 flex items-center max-lg:flex-col-reverse">

            <div class="lg:w-6/12 w-full relative z-20 h-auto shrink-1 grow-0 py-8 max-lg:pt-0 max-lg:px-10 max-sm:px-0">
                <div class="w-full max-lg:flex max-lg:items-end max-sm:items-center max-md:pt-5 max-sm:pt-0">
                    <div class="w-auto pr-8 max-sm:pr-4 max-md:hidden">
                    </div>
                    <div class="w-full">
                        <div class="font-bold text-lg md:text-xl lg:text-2xl text-balance text-white md:pt-4">Lorem Ipsum</div>
                        <div class="w-full">
                            <div class="flex flex-wrap gap-2 justify-start py-3 text-balance 2xl:max-w-5xl xl:max-w-4xl lg:max-w-3xl md:max-w-2xl sm:max-w-xl max-w-lg mx-auto *:relative *:font-semibold *:md:text-sm *:text-xs *:flex *:backdrop-blur-xl *:text-white/80 *:bg-white/10 *:border-2 *:border-white/10 *:hover:border-white/20 *:items-center *:gap-x-2 *:rounded-full *:md:pr-4 *:pr-3 *:pl-3 *:py-1 *:*:size-2 *:*:lg:size-2.5 *:*:opacity-90">
                                <a href="javascript:;" class="">
                                    <svg class="  !rounded-full overflow-hidden !size-3" stroke="currentColor" fill="none" stroke-width="3" viewBox="0 0 24 24" aria-hidden="true" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 0 0-3.7-3.7 48.678 48.678 0 0 0-7.324 0 4.006 4.006 0 0 0-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 0 0 3.7 3.7 48.656 48.656 0 0 0 7.324 0 4.006 4.006 0 0 0 3.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3-3 3"></path></svg>
                                    lorem &amp; lorem ipsum
                                </a>
                                <a href="javascript:;" class="">
                                    <svg class="  !rounded-full overflow-hidden !size-3" stroke="currentColor" fill="none" stroke-width="3" viewBox="0 0 24 24" aria-hidden="true" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 0 0-3.7-3.7 48.678 48.678 0 0 0-7.324 0 4.006 4.006 0 0 0-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 0 0 3.7 3.7 48.656 48.656 0 0 0 7.324 0 4.006 4.006 0 0 0 3.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3-3 3"></path></svg>
                ...
                <div class="mt-4 text-sm md:text-base opacity-80 text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae est nesciunt aperiam. Ullam dolore minima blanditiis tempora architecto rem</div>
                <div class="flex gap-3 pt-5">
                    <a href="javascript:;"  class="inline-flex justify-center rounded-full max-md:text-xs text-sm font-semibold max-md:py-2 py-3 px-4 ring-2 ring-gray-200 bg-white text-black hover:bg-white/80">
                        <span>
                    ...
                    <a href="javascript:;" class="max-md:hidden inline-flex justify-center rounded-full max-md:text-xs text-sm font-semibold max-md:py-2 py-3 px-4 bg-transparent text-white ring-2 ring-white hover:bg-white/10 hover:ring-white/80">
            ...
            <div class="lg:w-6/12 w-full relative z-10 h-auto max-lg:px-10 max-sm:px-2">
                <div class="flex gap-10 max-sm:gap-8 max-sm:justify-center">
                    <div class="xl:w-1/2 lg:w-2/3 md:w-1/3 max-sm:w-5/12 aspect-[700/1556] self-baseline object-cover object-center md:ring-8 ring-4 ring-red-800 md:ring-offset-8 ring-offset-4 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 -mt-10 overflow-hidden">
                        <Image class="size-full aspect-[2000/2000]  object-cover" width="2000" height="2000" src="/img/case7.webp" loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                    <div class="lg:w-1/2 h-full md:w-2/3 sm:w-auto xl:-ml-36 lg:-ml-24 max-md:-ml-20 mr-0 lg:aspect-[477/477] aspect-video self-end object-cover object-center md:ring-8 ring-4 ring-red-800 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 overflow-hidden">
                        <Image class="size-full aspect-[3000/3000]  object-cover object-top" width="3000" height="3000" src="/img/case8.webp"  loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mx-auto max-w-7xl mb-24 last:mb-10 px-6 lg:px-8 w-full shadow-2xl shadow-theme1/60 bg-theme1 rounded-3xl *:relative *:z-10 relative">
        <div class="mx-auto max-w-container gap-x-7 max-sm:gap-0 flex items-center max-lg:flex-col-reverse">
            ...
            <div class="lg:w-6/12 w-full relative z-10 h-auto max-lg:px-10 max-sm:px-2">
                <div class="flex gap-10 max-sm:gap-8 max-sm:justify-center">
                    <div class="xl:w-1/2 lg:w-2/3 md:w-1/3 max-sm:w-5/12 aspect-[700/1556] self-baseline object-cover object-center md:ring-8 ring-4 ring-red-800 md:ring-offset-8 ring-offset-4 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 -mt-10 overflow-hidden">
                        <Image class="size-full aspect-[2000/2000]  object-cover" width="2000" height="2000" src="/img/case1.webp" loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                    <div class="lg:w-1/2 md:w-2/3 sm:w-auto xl:-ml-36 lg:-ml-24 max-md:-ml-20 mr-0 lg:aspect-[477/477] aspect-video self-end object-cover object-center md:ring-8 ring-4 ring-red-800 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 overflow-hidden">
                        <Image class="size-full aspect-[3000/3000]  object-cover object-top" width="3000" height="3000" src="/img/case2.webp"  loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mx-auto max-w-7xl mb-24 last:mb-10 px-6 lg:px-8 w-full shadow-2xl shadow-theme1/60 bg-theme1 rounded-3xl *:relative *:z-10 relative">
        <div class="mx-auto max-w-container gap-x-7 max-sm:gap-0 flex items-center max-lg:flex-col-reverse">
            ...
            <div class="lg:w-6/12 w-full relative z-10 h-auto max-lg:px-10 max-sm:px-2">
                <div class="flex gap-10 max-sm:gap-8 max-sm:justify-center">
                    <div class="xl:w-1/2 lg:w-2/3 md:w-1/3 max-sm:w-5/12 aspect-[700/1556] self-baseline object-cover object-center md:ring-8 ring-4 ring-red-800 md:ring-offset-8 ring-offset-4 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 -mt-10 overflow-hidden">
                        <Image class="size-full aspect-[2000/2000]  object-cover" width="2000" height="2000" src="/img/case3.webp" loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                    <div class="lg:w-1/2 md:w-2/3 sm:w-auto xl:-ml-36 lg:-ml-24 max-md:-ml-20 mr-0 lg:aspect-[477/477] aspect-video self-end object-cover object-center md:ring-8 ring-4 ring-red-800 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 overflow-hidden">
                        <Image class="size-full aspect-[3000/3000]  object-cover object-top" width="3000" height="3000" src="/img/case4.webp"  loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mx-auto max-w-7xl mb-24 last:mb-10 px-6 lg:px-8 w-full shadow-2xl shadow-theme1/60 bg-theme1 rounded-3xl *:relative *:z-10 relative">
        <div class="mx-auto max-w-container gap-x-7 max-sm:gap-0 flex items-center max-lg:flex-col-reverse">
            ...
            <div class="lg:w-6/12 w-full relative z-10 h-auto max-lg:px-10 max-sm:px-2">
                <div class="flex gap-10 max-sm:gap-8 max-sm:justify-center">
                    <div class="xl:w-1/2 lg:w-2/3 md:w-1/3 max-sm:w-5/12 aspect-[700/1556] self-baseline object-cover object-center md:ring-8 ring-4 ring-red-800 md:ring-offset-8 ring-offset-4 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 -mt-10 overflow-hidden">
                        <Image class="size-full aspect-[2000/2000]  object-cover" width="2000" height="2000" src="/img/case5.webp" loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                    <div class="lg:w-1/2 md:w-2/3 sm:w-auto xl:-ml-36 lg:-ml-24 max-md:-ml-20 mr-0 lg:aspect-[477/477] aspect-video self-end object-cover object-center md:ring-8 ring-4 ring-red-800 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 overflow-hidden">
                        <Image class="size-full aspect-[3000/3000]  object-cover object-top" width="3000" height="3000" src="/img/case6.webp"  loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mx-auto max-w-7xl mb-24 last:mb-10 px-6 lg:px-8 w-full shadow-2xl shadow-theme1/60 bg-theme1 rounded-3xl *:relative *:z-10 relative">
        <div class="mx-auto max-w-container gap-x-7 max-sm:gap-0 flex items-center max-lg:flex-col-reverse">
            ...
            <div class="lg:w-6/12 w-full relative z-10 h-auto max-lg:px-10 max-sm:px-2">
                <div class="flex gap-10 max-sm:gap-8 max-sm:justify-center">
                    <div class="xl:w-1/2 lg:w-2/3 md:w-1/3 max-sm:w-5/12 aspect-[700/1556] self-baseline object-cover object-center md:ring-8 ring-4 ring-red-800 md:ring-offset-8 ring-offset-4 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 -mt-10 overflow-hidden">
                        <Image class="size-full aspect-[2000/2000]  object-cover" width="2000" height="2000" src="/img/case9.webp" loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                    <div class="lg:w-1/2 md:w-2/3 sm:w-auto xl:-ml-36 lg:-ml-24 max-md:-ml-20 mr-0 lg:aspect-[477/477] aspect-video self-end object-cover object-center md:ring-8 ring-4 ring-red-800 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 overflow-hidden">
                        <Image class="size-full aspect-[3000/3000]  object-cover object-top" width="3000" height="3000" src="/img/case10.webp"  loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                </div>
            </div>
        </div>
