...
<div class="relative py-6 md:py-8 lg:py-16 select-none px-10 max-sm:px-4 lg:mt-10 mt-20" id="allCaseStudy">
        ...
        <div class="mx-auto max-w-container gap-x-7 max-sm:gap-0 flex items-center max-lg:flex-col-reverse">
            ...
            <div class="lg:w-6/12 w-full relative z-20 h-auto shrink-1 grow-0 py-8 max-lg:pt-0 max-lg:px-10 max-sm:px-0">
                ...
                <div class="flex gap-3 pt-5">
                    <a href="javascript:;" target="_blank" class="inline-flex justify-center rounded-lg rounded-br-none max-md:text-xs text-sm font-semibold max-md:py-2 py-3 px-4 ring-2 ring-gray-200 bg-white text-black hover:bg-white/80">
                        <span>
                    ...
                    <a href="javascript:;" class="max-md:hidden inline-flex justify-center rounded-lg rounded-br-none max-md:text-xs text-sm font-semibold max-md:py-2 py-3 px-4 bg-transparent text-white ring-2 ring-white hover:bg-white/10 hover:ring-white/80">
            ...
            <div class="lg:w-6/12 w-full relative z-10 h-auto max-lg:px-10 max-sm:px-2">
                <div class="flex gap-10 max-sm:gap-8 max-sm:justify-center">
                    <div class="xl:w-1/2 lg:w-2/3 md:w-1/3 max-sm:w-5/12 aspect-[700/1556] self-baseline object-cover object-center md:ring-8 ring-4 ring-red-800 md:ring-offset-8 ring-offset-4 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 -mt-10 overflow-hidden">
                        <Image class="size-full aspect-[2000/2000]  object-cover" width="2000" height="2000" src="https://img.freepik.com/free-vector/smart-phone-with-isolated-realistic-white_2065-722.jpg?t=st=1726731302~exp=1726734902~hmac=f783bac3b30c5b3f7616dbba808b1ce425ce5555fcdde275a772b5a2b08f3cfa&w=740" loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                    <div class="lg:w-auto md:w-2/3 sm:w-auto xl:-ml-36 lg:-ml-24 max-md:-ml-20 mr-0 lg:aspect-[477/477] aspect-video self-end object-cover object-center md:ring-8 ring-4 ring-red-800 shadow-2xl shadow-red-800 md:rounded-3xl rounded-xl mb-10 overflow-hidden">
                        <Image class="size-full aspect-[2000/2000]  object-cover" width="2000" height="2000" src="https://img.freepik.com/premium-photo/macbook-pro-laptop-with-word-web-screen_1277297-31924.jpg?w=740"  loading="lazy" quality={90} sizes="100vw"  alt="image"/>
                    </div>
                </div>
            </div>
        </div>
