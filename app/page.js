...
export default function Home() {
    ...
    "
        ...
        <Link className="swiper-button-next swiper-button-nextHero [&.swiper-button-disabled]:!hidden max-lg:!hidden !top-[calc(100%-50%)] !right-8 !left-auto !w-10 !h-10 rounded-full flex items-center justify-center p-0 after:hidden duration-200 opacity-80 hover:opacity-100" area-hidden="true">
                ...
                ">
                    ...
                    ">
                                ...
                                <div className="mt-8 flex gap-4">
                                    <button class="px-4 text-sm text-[white] bg-[#0E508A] inline-flex items-center gap-2 font-semibold py-3 border-[#0E508A] border-2 w-max hover:bg-[#0E508A]/80 duration-300">
                                        <span>Read More</span>
                                        <span>
            ...
            <div class="relative isolate overflow-hidden pb-8 sm:pb-16 [critical:this]">
                <div class="overflow-hidden bg-gradient-to-b from-white to-slate-200 pt-6 md:pt-16 pb-36 sm:ps-0 ps-5 sm:pr-0 pr-5">
                    ...
                    <div class="relative container mx-auto max-w-7xl md:px-6 lg:px-8 z-10">
                        <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black text-center">
                            ...
                            <span class="font-bold text-[#C10913]"> For You?</span>
                        </p>
                        <div class="md:text-base text-sm text-black/70 mt-3 text-center">
                ...
                <div class="container py-5 bg-white text-center mt-[-126px] !pb-0 md:p-5 sm:p-8 p-5 mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                    ...
                    <div class="md:text-base text-sm text-black/70 mt-3">
                        ...
                        <div className="md:col-span-9 col-span-12 bg-[white] p-2 rounded-xl">
                            {
                                ...
                                <div className="p-4">
                                    <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight">
                                        <span class="font-normal">Trending </span>
                                        <span class="font-bold bg-gradient-to-r from-cyan-300 via-cyan-200 to-cyan-400 bg-clip-text text-[#C10913]"> Solutions</span>
                                    </p>
                                    <div class="md:text-base text-sm mt-3 mb-lg-1 md:font-semibold  ">  Explore our trending ready-to-use applications, meticulously crafted to elevate your business instantly. From cutting-edge food delivery apps to innovative elearning platforms, our trending solutions are designed to streamline operations.
                                    </div>
                                    <div class="py-10   *:flex *:flex-wrap *:gap-3 *:md:font-semibold *:text-[12px] *:md:text-sm *:*:inline-block *:*:backdrop-blur-lg *:*:shadow-sm *:*:p-2 *:*:md:p-3 ">
                                        <div>
                                        ...
                                        <div class="sm:text-lg text-base font-bold 0 mt-10">Core Tech:</div>
                                        <div class="flex items-center flex-wrap overflow-hidden mt-5 gap-8  *:w-auto *:text-center *:gap-2 *:*:text-center">
                                            <div>
                                                <div class="md:size-10 size-8 mx-auto">
                                            ...
                                            <div>
                                                ...
                                                <div class="sm:text-base text-sm font-semibold mt-1">React JS</div>
                                            </div>
                                            <div>
                                                <div class="md:size-10 size-8 mx-auto">
