...
function groceryAppDevelopment() {
    const accordionItems = [
        {
            title:
                "Which is the Best Grocery Delivery App Development Company?",
            content:
                "While numerous grocery delivery app development companies exist, Twin Power Software stands out as the top choice. With years of expertise in crafting grocery delivery app solutions, we've played a pivotal role in elevating various businesses to new heights. Join us to become the next market leader in the grocery industry.",
        },
        {
            title:
                "How Much Does Grocery Delivery App Development Services Cost?",
            content:
                "Determining the precise cost of developing an on-demand grocery delivery app is challenging. For accurate estimates and reliable development services, turn to Twin Power Software. Our experts will analyze your requirements and deliver the best solutions.",
        },
        {
            title:
                "How Can A Grocery Delivery App Benefit My Business?",
            content:
                "A grocery delivery app enhances customer convenience, boosts sales, and expands your market reach. We offer a seamless online shopping experience to businesses worldwide.",
        },
        {
            title:
                "Can I Customize the App According to My Business Needs?",
            content:
                "Yes, our grocery delivery app development services offer customization options. We tailor the app as per your specific business requirement. Apps developed by us ensure a unique and branded experience.",
        },
        {
            title:
                "What Support & Maintenance Services Do You Provide Post-launch?",
            content:
                "We offer ongoing mobile app support and maintenance to address any issues, updates, or enhancements. Our goal is to ensure your grocery delivery app operates seamlessly and stays current with evolving market trends.",
        },
    ];
                    ...
                    <div className="size-full relative !z-10">
                        <div className="colorApply1 flex size-full items-center rounded-b-2xl relative overflow-hidden shadow-lg before:absolute before:inset-0 before:bg-cover before:bg-right before:rounded-b-2xl before:bg-gradient-to-r before:mix-blend-multiply after:absolute after:rounded-b-2xl after:inset-0 after:bg-repeat   before:from-theme1 before:via-theme1/50 before:to-theme1/80">
                            ...
                            <Image
                                ...
                                height="812"
                                loading="lazy"
                                src="/img/grocery-delivery-1519w.webp"
...
"
                            ...
                            <div className="flex mx-auto max-lg:flex-col max-lg:gap-y-10 items-center 2xl:max-w-7xl xl:max-w-6xl lg:max-w-5xl md:max-w-3xl sm:max-w-3xl max-w-2xl px-6 lg:px-8 w-full relative lg:pt-40 sm:pt-32 pt-28 pb-12 overflow-hidden z-10 justify-between">
                                <div className="xl:w-7/12 lg:w-1/2 grow-0 max-lg:text-center">
                                    ...
                                    <div className="max-lg:text-sm text-base text-white/80 pt-5 text-pretty w-10/12 max-lg:mx-auto">
                                        Elevate your grocery business with a mobile app crafted by Twin Power Software, a top-tier Grocery Delivery App Development company. We specialize in creating intuitive grocery apps designed to serve both customers and businesses effectively. Trusted by companies worldwide, we help establish a strong market presence. Partner with us for a solution built to stand the test of time.
                                    </div>
                                </div>
                    ...
                    <div className="relative isolate overflow-hidden bg-theme1 px-6 shadow-2xl rounded-2xl sm:rounded-3xl sm:px-16 lg:flex lg:px-24 *:z-10">
                        <div className="lg:mx-0 lg:flex-auto py-6 md:py-8 lg:py-16 text-center relative z-[1] ">
                            <div className="max-sm:text-xl max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight text-white font-normal empty:hidden max-sm:text-center">
                                "The online grocery market is projected to reach $30.65 billion in revenue by 2024, with an annual growth rate of 20.30% from 2024 to 2028. In India,
                                <span className="font-bold text-gray-100">
                                    the market for online groceries surpassed 669 billion Indian rupees in 2023."{" "}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                "
                            >
                                <span className="font-normal">
                                    Create a Door-to-Door Grocery
                                </span>{" "}
                                <span className="font-bold">
                                    Delivery App Similar to Instacart.
                                </span>
                            </p>
                            <p className="mt-4 text-sm md:text-base leading-7 text-slate-600">
                                User-friendliness and convenience are increasingly driving the popularity of grocery delivery apps. It's no surprise that many turn to platforms like Instacart, which provide an effortless shopping experience and reliable checkout. Yet, the market still has unmet demands. We recognize these needs and can create a grocery delivery app solution that perfectly matches user expectations.
                            </p>
                            <p className="mt-4 text-sm md:text-base leading-7 text-slate-600">
                                At Twin Power Software, we believe that technology has the potential to transform lives and businesses. Our dedication to innovation motivates us to build strong and scalable solutions that address market challenges, positioning us among the top grocery delivery app development companies. Our team views every idea as a potential breakthrough, nurturing it with creativity and attention to detail to develop successful solutions. Have a concept in mind? Hire grocery app developers today!
                            </p>
                ...
                <div className="mx-auto max-w-7xl px-5 sm:px-24 md:px-32 xl:px-40 z-10">
                    <div className="relative container mx-auto max-w-7xl md:px-6 lg:px-8 z-10">
                        <p className="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black text-center">
                            <span className="font-normal text-center"> What Is the Functionality of an On-Demand </span>
                            <span className="font-bold text-theme2"> Food Delivery Solution?</span>
                        </p>
                    </div>
                    ...
                    <div className="pt-10 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
                        <div className="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[47%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2     sm:before:content-[''] sm:before:absolute sm:before:h-[3px] sm:before:w-[116px] sm:before:bg-zinc-600 sm:before:top-[47%] sm:before:left-[-113px] sm:before:-z-10 sm:before:translate-y-1/2">
                            ...
                            <div className="absolute h-[20px] w-[20px] top-[42%] left-[-126px] mt-[1px] lg:mt-[2px] text-zinc-600">
                                ...
                                <svg stroke="currentColor" fill="currentColor" className="h-full w-full text-zinc-600" stroke-width="0" viewBox="0 0 192 512" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg"><path d="M192 127.338v257.324c0 17.818-21.543 26.741-34.142 14.142L29.196 270.142c-7.81-7.81-7.81-20.474 0-28.284l128.662-128.662c12.599-12.6 34.142-3.676 34.142 14.142z"></path></svg>
                            </div>
                        </div>
            ...
            <section className="bg-gray-100">
                ...
                last:*:font-bold last:*:text-theme2
            ">    <span>Variety of Grocery</span>
                                <span> Delivery Models We Offer</span>
                            </p>
                            <div className="md:text-base text-sm text-black/70 mt-3">
                                Experience convenience with a diverse range of grocery delivery options, each tailored to meet your specific needs. We provide a selection that includes scheduled deliveries, on-demand service, and subscription-based plans. Enjoy the flexibility of choosing from a broad array of supermarket delivery models. Here’s a look at the extensive modules we offer.
                            </div>
                        </div>
                    </div>
        ...
        ">        <li>
                                <div className="group">
                                    ...
                                    <div className="title">On-Demand Grocery Delivery Model</div>
                                    <div className="tagline">
                                        With our on-demand grocery delivery model, you can revolutionize your business. Meet your customers' needs instantly with a responsive solution. Seamlessly integrate our robust platform to offer fast, immediate delivery. Opt for us to develop your on-demand grocery delivery app.
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="group">
                                    ...
                                    <div className="title">Scheduled Delivery Model</div>
                                    <div className="tagline">
                                    Our scheduled grocery delivery model enhances the grocery delivery experience. Allow your customers to choose their preferred delivery times, fitting deliveries into their routines. For top-notch development services, connect with our grocery delivery app development company.
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="group">
                                    ...
                                    <div className="title">Subscription-Based Grocery Delivery Model
                                    </div>
                                    <div className="tagline">
                                    Explore the future of food shopping with our subscription-based delivery model. By offering your clients a recurring delivery service, you provide a seamless experience. Deliver groceries effortlessly and on time. Boost customer loyalty and retention, and watch your business thrive in the subscription economy.
                                    </div>
                                </div>
                            </li>
                        </ul>
...
export default groceryAppDevelopment;
