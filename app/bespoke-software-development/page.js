              ...
              <div className="w-full lg:w-[60%]">
                <div className="container mx-auto max-w-7xl px-6 lg:px-8 relative z-10
                  ...
                  <ul>
                    <li>
                      <div>
                        <svg className="text-black" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="font-medium text-lg leading-7 py-2 text-black">SMBs</p>
                    ...
                    <li>
                      <div>
                        ...
                        <p className="font-medium text-lg leading-7 py-2 text-black ">Start-ups</p>
                    ...
                    <li>
                      <div>
                        ...
                        <p className="font-medium text-lg leading-7 py-2 text-black">Enterprises</p>
                    ...
                    <li>
                      <div>
                        ...
                        <p className="font-medium text-lg leading-7 py-2 text-black">Industries</p>
