...
"
                            ...
                            <div className="flex mx-auto max-lg:flex-col max-lg:gap-y-10 items-center 2xl:max-w-7xl xl:max-w-6xl lg:max-w-5xl md:max-w-3xl sm:max-w-3xl max-w-2xl px-6 lg:px-8 w-full relative lg:pt-40 sm:pt-32 pt-28 pb-12 overflow-hidden z-10 justify-between">
                                <div className="xl:w-7/12 lg:w-1/2 grow-0 max-lg:text-center">
                                    ...
                                    <div className="max-lg:text-sm text-base text-white/80 pt-5 text-pretty w-10/12 max-lg:mx-auto">
                                        If you're looking to create a cutting-edge fuel delivery app and capitalize on the growing trend of fuel convenience, Twin Power Software is your ideal partner. We specialize in developing advanced apps for seamless fuel delivery services.
                                    </div>
                                </div>
            ...
            "
                ...
                "
                            ...
                            <p className="mt-4 text-sm md:text-base leading-7 text-slate-600">
                                If you're motivated by leading platforms like GasBuddy and Fuelio and are eager to transform your business, now is the ideal moment. With the fuel delivery market expected to reach $8.9 billion by 2031, this growing trend presents a major opportunity. Twin Power Software can help you streamline your operations and elevate your customer experience with top-notch fuel delivery app development.
                            </p>
                            <p className="mt-4 text-sm md:text-base leading-7 text-slate-600">
                                We don’t just create apps; we ensure every aspect, from user experience to secure payment systems, is optimized for success. Bring your vision to life by hiring our skilled developers, and build a fuel delivery solution that drives innovation and boosts your business growth.
                            </p>
                ...
                <div class="mx-auto max-w-7xl px-5 sm:px-24 md:px-32 xl:px-40 z-10">
                    <div class="relative container mx-auto max-w-7xl md:px-6 lg:px-8 z-10">
                        <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black text-center">
                            <span class="font-normal text-center"> How Does On-Demand </span>
                            <span class="font-bold text-theme2">Fuel Delivery App Function? </span>
                        </p>
                    </div>
                    <div class="md:pt-20 pt-12 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
                        <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[47%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2    sm:before:content-[''] sm:before:absolute sm:before:border-[3px] sm:before:border-zinc-600 sm:before:inset-0 sm:before:top-[51%] sm:before:left-[-69%] sm:before:border-r-0  sm:before:sm:w-[140px] sm:before:w-[135px]  sm:before:h-[150px] sm:before:sm:h-[165px] sm:before:md:h-[180px] sm:before:lg:h-[214px] sm:before:rounded-tl-[18px] sm:before:rounded-bl-[18px]">
                            <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[30px] lg:w-[40px] mx-auto">
                                <svg class="size-full" viewBox="0 0 360 358" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="text-sm sm:text-base opacity-60 font-semibold pt-2 leading-[120%] px-3 text-ellipsis line-clamp-3">
                        ...
                        <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[47%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2">
                            <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[30px] lg:w-[40px] mx-auto">
                                <svg class="size-full" viewBox="0 0 396 430" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[47%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2">
                            <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[30px] lg:w-[40px] mx-auto">
                                <svg class="size-full" viewBox="0 0 470 449" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="pt-10 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
                        <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[47%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2">
                            <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[30px] lg:w-[40px] mx-auto">
                                <svg class="size-full" viewBox="0 0 512 340" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:border-[3px] sm:after:border-zinc-600 sm:after:inset-0 sm:after:top-[47%] sm:after:left-[100%] sm:after:border-l-0 sm:after:w-[90px] sm:after:sm:w-[140px] sm:after:h-[150px] sm:after:sm:h-[170px] sm:after:md:h-[180px] sm:after:lg:h-[225px] sm:after:rounded-tr-[18px] sm:after:rounded-br-[18px]">
                            <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[30px] lg:w-[40px] mx-auto">
                                <svg class="size-full" viewBox="0 0 459 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="pt-10 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
                        <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[47%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2     sm:before:content-[''] sm:before:absolute sm:before:h-[3px] sm:before:w-[116px] sm:before:bg-zinc-600 sm:before:top-[47%] sm:before:left-[-113px] sm:before:-z-10 sm:before:translate-y-1/2">
                            <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[30px] lg:w-[40px] mx-auto">
                                <svg class="size-full" viewBox="0 0 450 449" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="absolute h-[20px] w-[20px] top-[42%] left-[-126px] mt-[1px] lg:mt-[2px] text-zinc-600">

                                <svg stroke="currentColor" fill="currentColor" class="h-full w-full text-zinc-600" stroke-width="0" viewBox="0 0 192 512" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg"><path d="M192 127.338v257.324c0 17.818-21.543 26.741-34.142 14.142L29.196 270.142c-7.81-7.81-7.81-20.474 0-28.284l128.662-128.662c12.599-12.6 34.142-3.676 34.142 14.142z"></path></svg>
                            </div>
                        </div>
            ...
            <section class="bg-gray-100">
                ...
                last:*:font-bold last:*:text-theme2
            ">    <span>Wide Range of On-demand Fuel Delivery </span>
                                <span> Models We Offer</span>
                            </p>
                            <div class="md:text-base text-sm text-black/70 mt-3">    Discover the future of online fuel delivery. Have a look at our on-demand mobile app development model. We specialize in creating versatile fuel delivery platforms. Our solutions empower businesses to streamline fuel delivery operations efficiently. If you aim to enhance customer experience, avail our fuel delivery app development services. Revolutionize your fuel delivery business with our cutting-edge solutions.
                            </div>
                        </div>
                    </div>
        ...
        ">        <li>
                                <div class="group">
                                    <div class="icon group-hover:bg-theme1 group-hover:text-white">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M217.4 27.43c-27.9.47-53.1 17.11-64.5 42.84l136.5 41.23c6-35.79-15.5-70.49-50.1-81.02-6.2-1.88-12.7-2.91-19.2-3.05h-2.7zm-69.7 60.08c-6.1 35.89 15.4 70.69 50.1 81.19 34.8 10.5 71.9-6.7 86.5-40zm265.5 44.29c-25.3.1-52.2 12.3-72.5 41L215.9 349.7c-33.5 47.4-18.9 97 14.1 120.4 33.1 23.5 84.6 20.8 118.1-26.6l124.7-176.8c33.5-47.5 18.9-97-14.1-120.5-12.4-8.8-27.3-13.9-43-14.4zm-1.8 17.3c1.3 0 2.6 0 3.8.1 12.1.5 23.5 4.8 33.1 11.7 25.7 18.2 38.6 54.5 9.7 95.4l-64.5 91.5c-35.8-9.6-81.8-42.3-102.7-73l64.7-91.6c16.9-23.9 37-33.7 55.9-34.1zM91.25 225.3c-9.62.1-19.11 2.1-27.93 6-33.11 14.5-50.34 51.5-40.24 86.3l130.72-57.1c-13.1-22.1-36.9-35.5-62.55-35.2zm69.65 51.6L30.2 334.1c18.45 31.4 57.3 44 90.6 29.5 33.2-14.6 50.4-51.8 40.1-86.7z"></path></svg>
                                    </div>
                                    <div class="title">Consumer App-Based Model</div>
                                    <div class="tagline">In this model, customers can order fuel using a mobile application. They simply specify their location and the amount of fuel needed. A delivery truck is dispatched to their location to fill up their vehicle's tank. The app handles payment processing. It also provides real-time tracking of the delivery.</div>
                                </div>
                            </li>
                            <li>
                                <div class="group">
                                    <div class="icon group-hover:bg-theme1 group-hover:text-white">
                                        <svg stroke="currentColor" fill="none" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3"></path></svg>
                                    </div>
                                    <div class="title">Subscription-Based Model</div>
                                    <div class="tagline">This model involves offering subscription plans. Here, customers pay a monthly or yearly fee to have fuel delivered to their specified location. Customers can choose the frequency and quantity of deliveries. This model offers convenience and cost savings for customers who require regular fuel refills.</div>
                                </div>T
                            </li>
                            <li>
                                <div class="group">
                                    ...
                                    <div class="title">Corporate/Commercial Model</div>
                                    <div class="tagline">This model targets businesses and organizations with fleets of vehicles. You can offer customized fuel delivery solutions tailored to the client’s needs. This may involve setting up on-site fuel storage tanks. You can also establish scheduled delivery routes to ensure timely refills without any disruption.</div>
                                </div>
                            </li>
                        </ul>
                    </div>
