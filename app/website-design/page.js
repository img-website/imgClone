    ...
    <div class="container pt-5 md:p-5 sm:p-8 p-5 mx-auto max-w-7xl px-6 lg:px-8 relative z-10 flex">
        ...
        <div class="lg:w-4/12 sm:w-1/2 w-full sm:p-6 sm:px-6 py-6">
            <div class="relative block h-full bg-white shadow-md rounded-lg rounded-br-none p-6 pt-10 group">
                <div class="font-bold text-slate-900 md:text-xl text-lg relative before:absolute before:left-0 before:top-[-16px] before:h-[4px] before:w-[40px] before:bg-gradient-to-r before:from-theme1 before:to-theme1/70 ">Fueled by Experienced Professionals</div>
                <div class="text-black text-sm mt-2 text-ellipsis line-clamp-4 ">Our team consists of expert designers who understand the value of your ideas and transform them into feature-rich realities. We have successfully delivered our services to thousands of clients, fostering long-term relationships along the way.</div>
        ...
        <div class="lg:w-4/12 sm:w-1/2 w-full sm:p-6 sm:px-6 py-6">
            <div class="relative block h-full bg-white shadow-md rounded-lg rounded-br-none p-6 pt-10 group">
                <div class="font-bold text-slate-900 md:text-xl text-lg relative before:absolute before:left-0 before:top-[-16px] before:h-[4px] before:w-[40px] before:bg-gradient-to-r before:from-theme1 before:to-theme1/70 ">Punctual Work Completion </div>
                <div class="text-black text-sm mt-2 text-ellipsis line-clamp-4 ">Our business has grown significantly, and we aim to maintain this momentum by delivering work on time. Every client who trusts us is our responsibility, and we strive to work effectively and efficiently to meet their needs.</div>
                <div class="sm:h-16 sm:w-16 h-14 w-14 bg-white rounded-lg rounded-br-none absolute right-[30px] top-[-30px] p-3 shadow-md duration-300 group-hover:bg-slate-900/90 ">
        ...
        <div class="lg:w-4/12 sm:w-1/2 w-full sm:p-6 sm:px-6 py-6">
            <div class="relative block h-full bg-white shadow-md rounded-lg rounded-br-none p-6 pt-10 group">
                <div class="font-bold text-slate-900 md:text-xl text-lg relative before:absolute before:left-0 before:top-[-16px] before:h-[4px] before:w-[40px] before:bg-gradient-to-r before:from-theme1 before:to-theme1/70 ">Provide Genuine Value</div>
                <div class="text-black text-sm mt-2 text-ellipsis line-clamp-4 ">As a trusted and reputable website design company, we are committed to working honestly and delivering genuine value to our clients.</div>
                <div class="sm:h-16 sm:w-16 h-14 w-14 bg-white rounded-lg rounded-br-none absolute right-[30px] top-[-30px] p-3 shadow-md duration-300 group-hover:bg-slate-900/90 ">
        ...
        <div class="lg:w-4/12 sm:w-1/2 w-full sm:p-6 sm:px-6 py-6">
            <div class="relative block h-full bg-white shadow-md rounded-lg rounded-br-none p-6 pt-10 group">
                <div class="font-bold text-slate-900 md:text-xl text-lg relative before:absolute before:left-0 before:top-[-16px] before:h-[4px] before:w-[40px] before:bg-gradient-to-r before:from-theme1 before:to-theme1/70 ">Conduct Research and Honor Your Ideas</div>
                <div class="text-black text-sm mt-2 text-ellipsis line-clamp-4 ">We conduct thorough research based on your requirements and ideas, making the process of building your dream website smoother and more efficient.</div>
                <div class="sm:h-16 sm:w-16 h-14 w-14 bg-white rounded-lg rounded-br-none absolute right-[30px] top-[-30px] p-3 shadow-md duration-300 group-hover:bg-slate-900/90 ">
