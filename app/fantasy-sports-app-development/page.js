...
function fantasysportsappdevelopment() {
  ...
  return (
    <>
        ...
        <div className="absolute top-1/2 -translate-y-1/2 flex items-center px-8 sm:px-12 md:px-16 h-full text-white mx-auto w-full">
          <div className="w-full">
            ...
            <div className=" lg:w-2/3 w-full mx-auto mix-blend-color-dodge sm:mt-2  px-5 md:py-10 py-2 sm:py-8 md:rounded-2xl rounded-xl !shadow-xl bg-white/5 relative gap-6 flex flex-col before:absolute before:inset-4 md:hover:before:inset-1 before:duration-200 before:ease-in before:bg-theme2/5 before:rounded-xl before:!before:z-0 before:m-auto *:w-full *:z-10 shadow-white/10">
              ...
              <fieldset className="sm:px-8 px-4 w-full overflow-hidden">
                <div className="sm:mt-3 grid grid-cols-2 sm:grid-cols-4 -mx-3 gap-4">
                  <div className="grow">
                    <Link href="javascript:;" className="text-gray-200 has-[:checked]:ring-indigo-200 has-[:checked]:text-indigo-900 has-[:checked]:bg-indigo-50 flex flex-col gap-2 items-center rounded-lg md:p-4 p-2 ring-1 ring-transparent border border-white/20 md:hover:border-white justify-center font-bold max-sm:text-sm">
                      <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" className="sm:size-12 size-5 mx-auto" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M15.05 12.81 6.56 4.32a.996.996 0 0 0-1.41 0L2.32 7.15a.996.996 0 0 0 0 1.41l8.49 8.49c.39.39 1.02.39 1.41 0l2.83-2.83a.996.996 0 0 0 0-1.41zM14.341 17.756l1.414-1.414 4.243 4.243-1.414 1.414z"></path><circle cx="18.5" cy="5.5" r="3.5"></circle></svg>
                      Cricket
            ...
            <div className="max-lg:text-sm max-sm:line-clamp-3 text-base text-center text-white pt-5 text-balance max-lg:mx-auto">
      ...
      <section className="lg:py-10 relative xl:mr-0 lg:mr-5 mr-0">
