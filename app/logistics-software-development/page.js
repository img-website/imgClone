            ...
            <div className="relative bg-gray-100 py-6 md:py-8 lg:py-16 ">
                ...
                ">
                        ...
                        <div className="w-full grid lg:grid-cols-3 md:grid-cols-1 gap-8 mb-6">
                            <div className="md:col-span-2 group rounded-[20px] relative  md:hover:shadow-gray-700/40 duration-300">
                                <div className="bg-theme1 text-white rounded-[20px] duration-300 p-2 shadow-xl shadow-black/20 md:group-hover:shadow-black/0 h-full">
                                    <div className="flex p-3 flex-col gap-3">
                                        <div className="lg:text-6xl md:text-4xl text-3xl font-bold text-white *:size-full size-20">
                        ...
                        <div className="w-full grid lg:grid-cols-3 md:grid-cols-1 gap-8 mb-6">
                            <div className="lg:order-last md:col-span-2 group rounded-[20px] relative  md:hover:shadow-xl  duration-300">
                                <div className="bg-theme2 text-white rounded-[20px] duration-300 p-2 shadow-xl shadow-black/20 md:group-hover:shadow-black/0 h-full">
                                    <div className="flex p-3 flex-col gap-3">
                                        <div className="lg:text-6xl md:text-4xl text-3xl font-bold text-white *:size-full size-20">
                        ...
                        <div className="w-full grid lg:grid-cols-3 md:grid-cols-1 gap-8 mb-6">
                            <div className="md:col-span-2 group rounded-[20px] relative  duration-300">
                                <div className="bg-theme1 text-white rounded-[20px] duration-300 p-2 shadow-xl shadow-black/20 md:group-hover:shadow-black/0 h-full">
                                    <div className="flex p-3 flex-col gap-3">
                                        <div className="lg:text-6xl md:text-4xl text-3xl font-bold text-white *:size-full size-20">
                        ...
                        <div className="w-full grid lg:grid-cols-3 md:grid-cols-1 gap-8 mb-6">
                            <div className="md:col-span-2 group rounded-[20px] relative  md:hover:shadow-xl  duration-300">
                                <div className="bg-theme1 text-white rounded-[20px] duration-300 p-2 shadow-xl shadow-black/20 md:group-hover:shadow-black/0 h-full">
                                    <div className="flex p-3 flex-col gap-3">
                                        <div className="lg:text-6xl md:text-4xl text-3xl font-bold text-white-500 *:size-full size-20">
                                ...
                                <div class="flex flex-col justify-center items-center mt-12">
                                    <div class="flex flex-1 flex-col justify-center items-center rounded-xl p-4">
                                        ...
                                        <p class="mt-2 mb-10 sm:text-base text-sm leading-6 font-normal text-gray-500 line-clamp-6 text-ellipsis w-full">
                                            Logistics applications provide businesses with real-time visibility across the entire supply chain, allowing them to track shipments, monitor inventory levels, and assess order progress.
                                        </p>
                                    </div>
                            ...
                            <div class="h-full md:group md:hover:shadow-2xl md:hover:shadow-amber-300 duration-300 bg-white p-4 pb-0 m-2 rounded-lg shadow-2xl relative before:absolute before:h-12 before:w-4 before:bg-amber-600 before:-left-4 before:top-5 after:absolute after:size-8 after:-z-10 after:rotate-45 after:top-[52px] after:-left-2 after:bg-amber-600">
                                <div class="flex flex-col justify-center items-center mt-12">
                                    <div class="flex flex-1 flex-col justify-center items-center rounded-xl p-4">
                                        ...
                                        <p class="mt-2 mb-10 sm:text-base text-sm leading-6 font-normal text-gray-500 line-clamp-6 text-ellipsis w-full">
                                            By leveraging advanced analytics and route optimization algorithms, logistics apps facilitate the optimization of transportation routes, reducing fuel consumption and minimizing overall logistics costs.
                                        </p>
                                    </div>
                                    <div class="flex absolute bottom-0 items-center justify-center">
                            ...
                            <div class="h-full md:group md:hover:shadow-2xl md:hover:shadow-cyan-300 duration-300 bg-white p-4 pb-0 m-2 rounded-lg shadow-2xl relative before:absolute before:h-12 before:w-4 before:bg-cyan-700 before:-left-4 before:top-5 after:absolute after:size-8 after:-z-10 after:rotate-45 after:top-[52px] after:-left-2 after:bg-cyan-700">
                                <div class="flex flex-col justify-center items-center mt-12">
                                    <div class="flex flex-1 flex-col justify-center items-center rounded-xl p-4">
                                        ...
                                        <p class="mt-2 mb-10 sm:text-base text-sm leading-6 font-normal text-gray-500 line-clamp-6 text-ellipsis w-full">
                                            Logistics apps enhance the customer experience by offering features such as order tracking, delivery notifications, and open communication. Meeting customer expectations fosters loyalty and satisfaction.
                                        </p>
                                    </div>
                                    <div class="flex absolute bottom-0 items-center justify-center">
                            ...
                            <div class="h-full md:group md:hover:shadow-2xl md:hover:shadow-rose-300 duration-300 bg-white p-4 pb-0 m-2 rounded-lg shadow-2xl relative before:absolute before:h-12 before:w-4 before:bg-rose-900 before:-left-4 before:top-5 after:absolute after:size-8 after:-z-10 after:rotate-45 after:top-[52px] after:-left-2 after:bg-rose-900">
                                <div class="flex flex-col justify-center items-center mt-12">
                                    <div class="flex flex-1 flex-col justify-center items-center rounded-xl p-4">
                                        ...
                                        <p class="mt-2 mb-10 sm:text-base text-sm leading-6 font-normal text-gray-500 line-clamp-6 text-ellipsis w-full">
                                            Logistics apps enhance inventory management for businesses by providing real-time stock level information, preventing stockouts, and reducing excess inventory.
                                        </p>
                                    </div>
                                    <div class="flex absolute bottom-0 items-center justify-center">
                            ...
                            <div class="h-full md:group md:hover:shadow-2xl md:hover:shadow-sky-300 duration-300 bg-white p-4 pb-0 m-2 rounded-lg shadow-2xl relative before:absolute before:h-12 before:w-4 before:bg-sky-600 before:-left-4 before:top-5 after:absolute after:size-8 after:-z-10 after:rotate-45 after:top-[52px] after:-left-2 after:bg-sky-600">
                                <div class="flex flex-col justify-center items-center mt-12">
                                    <div class="flex flex-1 flex-col justify-center items-center rounded-xl p-4">
                                        ...
                                        <p class="mt-2 mb-10 sm:text-base text-sm leading-6 font-normal text-gray-500 line-clamp-6 text-ellipsis w-full">
                                            These apps promote improved communication and collaboration among suppliers, manufacturers, distributors, and other stakeholders in the supply chain. Specific features facilitate a more coordinated and efficient supply chain network.
                                        </p>
                                    </div>
                                    <div class="flex absolute bottom-0 items-center justify-center">
                                        <div class="w-28 h-5 bg-sky-500 rounded-full border-t-4 border-sky-600 relative before:absolute before:w-12 before:aspect-[1/1] before:rounded-full before:bg-sky-500 before:-top-8 before:left-1/2 before:-translate-x-1/2 before:text-3xl before:font-bold before:text-white before:flex before:items-center before:justify-center "></div>
                            ...
                            <div class="h-full md:group md:hover:shadow-2xl md:hover:shadow-amber-300 duration-300 bg-white p-4 pb-0 m-2 rounded-lg shadow-2xl relative before:absolute before:h-12 before:w-4 before:bg-amber-600 before:-left-4 before:top-5 after:absolute after:size-8 after:-z-10 after:rotate-45 after:top-[52px] after:-left-2 after:bg-amber-600">
                                <div class="flex flex-col justify-center items-center mt-12">
                                    <div class="flex flex-1 flex-col justify-center items-center rounded-xl p-4">
                                        ...
                                        <p class="mt-2 mb-10 sm:text-base text-sm leading-6 font-normal text-gray-500 line-clamp-6 text-ellipsis w-full">
                                            Logistics applications are designed to be scalable and flexible, allowing them to adapt to evolving business needs. These apps provide a dependable solution for addressing future logistical requirements.
