...
function customerRelationshipManagement() {
    return (
        <>
                            ...
                            <div class="border-2 p-5 group rounded-3xl border-black relative before:absolute before:size-24 before:border-t-[10px] before:border-l-[10px] before:rounded-tl-3xl before:border-fuchsia-500 before:-inset-[5px] md:hover:shadow-xl md:hover:shadow-fuchsia-700/40 duration-300">
                                <div class="bg-white duration-300 p-2 shadow-xl shadow-black/20 md:group-hover:shadow-black/0 rounded-3xl h-full">
                                    <div class="flex p-3 flex-col gap-3">
                                        ...
                                        <div class="md:text-lg sm:text-base text-sm leading-6 capitalize font-bold">
                                            EASY TO USE
                                        </div>
            ...
            {/* service start */}
            <div class="bg-theme1 relative overflow-hidden select-none py-6 md:py-8 lg:py-16">

                <div class="mx-auto max-w-7xl px-6 lg:px-8  z-40 relative">
                    <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-center text-white">
                        <span class="font-normal">Additional On-Demand App Development </span>
                        <span class="font-bold text-white"> Services We Provide</span>
                    </p>
