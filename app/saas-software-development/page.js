                        ...
                        <ul className="flex flex-row flex-wrap w-full relative z-40 items-stretch text-gray-800 pt-5 *:lg:w-1/3 *:md:w-1/2 *:h-auto *:p-3 *:*:size-full *:*:bg-white *:*:rounded-3xl *:*:p-6 *:*:relative *:*:shadow-lg *:*:duration-500 *:*:transition-all [&_.icon]:size-10 [&_.icon]:text-gray-700 [&_.icon>svg]:size-full [&_.title]:text-lg [&_.title]:font-semibold [&_.title]:text-gray-900 [&_.title]:py-3 [&_.tagline]:text-base [&_.tagline]:text-gray-600">
                            <li>
                                <div>
                                    ...
                                    <div className="title">Integration of Enterprise Resource Planning (ERP) Systems</div>
                            ...
                            <li>
                                <div>
                                    ...
                                    <div className="title">Business Intelligence and Data Analytics Platforms</div>
                                    <div className="tagline">
                            ...
                            <li>
                                <div>
                                    ...
                                    <div className="title">CRM Solutions for Enhanced Customer Engagement</div>
                                    <div className="tagline">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <p className="title">Enterprises</p>
                                                <p className="tagline">
            ...
            ">
                        <li>
                            <div>
                                ...
                                <div>
                                    <div className="title">Tailored SaaS Development Services</div>
                                    <div className="tagline">
                        ...
                        <li>
                            <div>
                                ...
                                <div>
                                    <div className="title">SaaS Product Improvement Services</div>
                                    <div className="tagline">
                        ...
                        <li>
                            <div>
                                ...
                                <div>
                                    <div className="title">SaaS Transition Services</div>
                                    <div className="tagline">
                        ...
                        <li>
                            <div>
                                ...
                                <div>
                                    <div className="title">SaaS Support and Maintenance Services</div>
                                    <div className="tagline">
