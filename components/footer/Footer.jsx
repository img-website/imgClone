            ...
            <section className="pb-20 sm:pb-10 py-10 bg-gray-900 sm:pt-16 lg:pt-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
                        <div>
                            ...
                            <ul className="mt-8 space-y-4">
                                <li>
                                    <a href="/about-us" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> About Us </a>
                                </li>
                                <li>
                                    <a href="/testimonial" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Testimonial </a>
                                </li>
                                <li>
                                    <a href="/case-study" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Case Study </a>
                                </li>
                                <li>
                                    <a href="/contact-us" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Contact Us </a>
                                </li>
                            </ul>
                        </div>

                        <div>
                            <p className="text-base text-white font-bold">Our Exclusive Services</p>

                            <ul className="mt-8 space-y-4">
                                <li>
                                    <a href="/web-development" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Web-development </a>
                                </li>
                                <li>
                                    <a href="/ecommerce-development" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> ecommerce-development </a>
                                </li>
                                <li>
                        ...
                        <div>
                            <p className="text-base text-white font-bold">On Demand Solutions</p>

                            <ul className="mt-8 space-y-4">
                                <li>
                                    <a href="/food-delivery-app-development" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Food-Delivery-App </a>
                                </li>
                                <li>
                                    <a href="/grocery-app-development" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Grocery-Delivery-App </a>
                                </li>
                                <li>
                                    <a href="/medicine-delivery-app-development" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Medicine-Delivery-App</a>
                                </li>
                                <li>
                                    <a href="/home-service-app-development" title="" className="text-base opacity-80 text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Home-Service-App </a>
                                </li>
                                <li>
                    ...
                    <div className="flex flex-wrap items-center justify-between max-sm:justify-center h-16">
                        ...
                        <ul className="flex items-center space-x-3 md:order-3 max-sm:mt-3">
                            <li>
