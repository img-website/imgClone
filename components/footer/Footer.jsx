                    ...
                    <div className="w-full flex flex-wrap items-center md:justify-between justify-center md:gap-0 gap-5 ">
                        <div className="w-auto">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex flex-shrink-0 items-center justify-center">
                                    <Link
                                        target="_blank"
                                        href="https://www.goodfirms.co/company/img-global-infotech-pvt-ltd"
                                    >
                                        <img
                                ...
                                <div className="flex flex-shrink-0 items-center justify-center">
                                    <iframe
                                        width="130"
                                        height="130"
                                        src="https://shareables.clutch.co/share/badges/237597/5993?utm_source=clutch_top_company_badge&utm_medium=image_embed"
                                        title="Top Clutch E-commerce Developers Jaipur 2024"
                                    ></iframe>
                                </div>
                            </div>
                            <div className="flex items-center justify-center mx-auto">
                                ...
                                >
                                    <iframe
                                        ...
                                        title="Twin Power Software Pvt. Ltd Clutch Review Widget 7"
                                    ></iframe>
                                </div>
                            </div>
                        </div>
                        <div className="w-auto">
                            ...
                            <div className="w-full flex flex-wrap items-center justify-center lg:gap-4 pt-8">
                                ...
                                >
                                    <svg
                                        className="size-full group-hover/social:text-white group-hover/social:scale-100 scale-95 duration-300"
                                        stroke="currentColor"
                                        fill="currentColor"
                                        strokeWidth="0"
                                        viewBox="0 0 320 512"
                                ...
                                <Link
                                    target="_blank"
                                    title="Twitter"
                                    href="https://twitter.com/imgglobal"
                    ...
                    <div className="w-full flex flex-wrap py-12 my-8 gap-y-10 border-y border-white/20">
                        ...
                        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3">
                            <div className="flex flex-col w-full px-3 text-sm lg:text-base">
                                ...
                                <div className="w-full opacity-80 pb-1">
                                    1090, gandhi Nagar, nehru Marg, Near , , Delhi - 302019
                                </div>
                                <div className="w-full opacity-80">
                                    Phone :+91-0987654321 , +91-0987654321{" "}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3">
                            <div className="flex flex-col w-full px-3 text-sm lg:text-base">
                                ...
                                <div className="w-full opacity-80 pb-1">
                                    203 Schm No.2 near city park, Kolkata
                                </div>
