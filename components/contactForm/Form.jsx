      ...
      <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
            <div className="grid grid-cols-1 gap-6 text-center sm:px-8 md:px-0 md:grid-cols-3">
              ...
              <div className="overflow-hidden bg-white rounded-xl">
                <div className="p-6">
                  ...
                  <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900">
                    1449 Richmond Ter , Staten Island, New York , USA
                  </p>
                </div>
              </div>
            </div>
                ...
                <form action="#" method="POST" className="mt-14">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    ...
                    <div className="sm:col-span-2">
                      <button
                        type="submit"
                        className="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md bg-theme1 focus:outline-none hover:bg-theme1/90 focus:bg-theme1/90"
                      >
                        Send
                      </button>
                    </div>
